    ...
    <tbody>
        <?php foreach($data as $d){ ?>
            <tr>
                ...
                <?php } ?>
                <td class="d-flex">
                    <form data-confirm="Are you sure you want to delete this <?= $action ?>?" method="POST" action="/action/<?= $action ?>">
                    ...
                    <?php if(isset($approve)){ ?>
                        <form data-confirm="Are you sure you want to <?= $d[$approve]?'disapprove':'approve' ?> this <?= $action ?>?" method="POST" action="/action/<?= $action ?>">
                            <input type="hidden" name="redirect" value="<?= $url ?>">
