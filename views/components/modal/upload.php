<div id="modal" class="modal__overlay">
    ...
    <div class="container">
        <div class="modal">
            ...
            <form class="form--validate" method="POST" action="/controller/upload" enctype="multipart/form-data">
                <div class="form__group">
                    <input data-fieldname="File" data-rules="required" type="file" name="file" placeholder="File *">
                </div>

                <small class="d-block mt-1"><a class="color-default" href="/uploads/sample.csv" download>Download sample file format</a></small>
