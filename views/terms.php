<div class="container">
        <section class="d-block d-md-grid grid-cols-12">
            <div class="col-span-8 col-start-3">
                <div class="heading">
                    <h1 class="title title--lg">Terms and Conditions</h1>
                </div>
                <p>
                    Hello! Welcome to Best Bookmarks Terms of Service. Please read this carefully
                    before using our site, services, or products. This is a contract between
                    you and Best Bookmarks. We've also included several annotations that aren't a part
                ...
                </p><h2>1. Accepting the Terms of Service</h2><p>
                    Please read these Terms of Service and our Community Guidelines
                    (collectively, the "<strong>Agreement</strong>") carefully before using
                    https://www.bestbookmarks.win (the "<strong>Site</strong>") and/or the other domains,
                    websites, products, applications, mobile applications, services, and/or
                    Content provided by  Best Bookmarks, Inc. (all of those collectively with the Site,
                    the "<strong>Services</strong>") ( Best Bookmarks, Inc., a Delaware corporation and
                    wholly-owned subsidiary of Oath Inc., a Delaware corporation ("    <strong>Oath</strong>"), collectively with its agents, representatives,
                    consultants, employees, officers, and directors, "<strong>Best Bookmarks</strong>,"
                    "<strong>we</strong>," or "<strong>us</strong>"). By using or accessing the
                    Services, you ("<strong>Subscriber</strong>" or "<strong>you</strong>")
                    ...
                    shouldn't, and aren't permitted to, use the Services. Best Bookmarks personalized
                    Services cannot be provided and the terms of this Agreement cannot be
                    performed without Best Bookmarks processing information about you and other users.
                    Processing of the information you share with Best Bookmarks is essential to the
                    ...
                    We’re just letting you know, here, that Best Bookmarks is now part of Oath, a
                    ...
                    , which apply to your use of  Best Bookmarks, have been updated to reflect this
                    change. This section also includes an agreement where you're agreeing to
                    agree to the terms of this Agreement.
                </p><h2>2. Modifications to this Agreement</h2><p>
                    Best Bookmarks reserves the right to modify this Agreement by (1) posting a revised
                    ...
                    Best Bookmarks Dashboard or in our mobile applications). Modifications will not
                    ...
                    Best Bookmarks received your prepayment.
                </p><p class="annotation inside">
                    As Best Bookmarks grows and improves, we might have to make changes to these Terms
                    ...
                    this document.
                </p><h2>3. Use of the Services</h2><p><strong>Eligibility:</strong></p><p>
                    You  may not use the Services, provide any personal information to  Best Bookmarks,
                    ...
                    with Best Bookmarks and are not legally prohibited from using the Services.
                </p><p class="annotation inside">
                    You have to be the Minimum Age to use Best Bookmarks. We're serious: it's a hard
                    rule. “But I’m, like, almost old enough!” you plead. Nope, sorry. If
                    you're not old enough, don't use Best Bookmarks. Ask your parents for a
                    Playstation 4, or try books.
                </p><p><strong>Service Changes and Limitations:</strong></p><p>
                    The Services change frequently, and their form and functionality may change
                    without prior notice to you. Best Bookmarks retains the right to create limits on
                    and related to use of the Services in its sole discretion at any time with
                    or without notice. Best Bookmarks may also impose limits on certain Services or
                    aspects of those Services or restrict your access to parts or all of the
                    Services without notice or liability. Best Bookmarks may change, suspend, or
                    ...
                    below). Best Bookmarks may also terminate or suspend Accounts (as defined below) at
                    any time, in its sole discretion.
                </p><p class="annotation inside">
                    Best Bookmarks is an ever-evolving platform. With new products, services, and
                ...
                </p><p><strong>Limitations on Automated Use:</strong></p><p>
                    ...
                    Best Bookmarks and/or its service providers; (b) probe, scan, or test any system or
                    ...
                    that are provided by Best Bookmarks (and only pursuant to those terms and
                    conditions) or unless permitted by Best Bookmarks's robots.txt file or other robot
                    ...
                    Don't do bad things to Best Bookmarks or to other users. Some particularly
                    egregious examples of "bad things" are listed in this section.
                </p><h2>4. Registration, Best Bookmarks URLs, and Security</h2><p>
                    As a condition to using certain of the Services and in order for us to
                    provide them to you, you may be required to create an account (an "    <strong>Account</strong>"), provide your age and an email address and
                    select a password and Best Bookmarks username, which will serve as a default link
                    to your default Best Bookmarks blog of the form [username].www.bestbookmarks.win (a "    <strong>Best Bookmarks URL</strong>"). You must select a different Best Bookmarks URL for
                    each new blog you create.
                </p><p>
                    You agree to provide Best Bookmarks with accurate, complete, and updated
                    registration information, particularly your email address.
                </p><p class="annotation inside">
                    It's really important that the email address associated with your Best Bookmarks
                    ...
                    Best Bookmarks immediately of any actual or suspected loss, theft, or unauthorized
                    use of your Account or Account password.
                </p><h2>5. Privacy</h2><p>
                    For information about how Best Bookmarks collects, uses, and shares your
                    ...
                    by Best Bookmarks and the Best Bookmarks Affiliates (as defined below).
                </p><h2>6. Content and Subscriber Content</h2><p><strong>Definitions:</strong></p><p>
                    For purposes of this Agreement: (1) the term "<strong>Content</strong>"
                    ...
                    accessible on or through the Services; (2) the term "    <strong>Subscriber Content</strong>" means Content that a Subscriber
                    submits, transfers, or otherwise provides to the Services. Content
                    includes, without limitation, all Subscriber Content.
                </p><p><strong>Your Rights in Subscriber Content:</strong></p><p>
                    Subscribers retain ownership and/or other applicable rights in Subscriber
                    Content, and Best Bookmarks and/or third parties retain ownership and/or other
                    ...
                    Best Bookmarks.
                </p><p><strong>Subscriber Content License to Best Bookmarks:</strong></p><p>
                    When you provide Subscriber Content to Best Bookmarks through the Services, you
                    grant Best Bookmarks a non-exclusive, worldwide, royalty-free, sublicensable,
                    ...
                    for the limited purposes of allowing Best Bookmarks to operate the Services in
                    ...
                    derivative works" is not intended to give Best Bookmarks a right to make
                    substantive editorial changes or derivations, but does, for example, enable    <strong>reblogging</strong>, which allows Best Bookmarks Subscribers to
                    redistribute Subscriber Content from one Best Bookmarks blog to another in a manner
                    that allows them to add their own text or other Content before or after
                    your Subscriber Content.
                </p><p class="annotation inside">
                    When you upload your creations to  Best Bookmarks, you’re giving us permission to
                    make them available in all the ways you would expect us to (for example,
                    via your blog, RSS, the Best Bookmarks Dashboard, etc.). We never want to do
                    anything with your work that surprises you.
                </p><p class="annotation inside">
                    Something else worth noting: Countless Best Bookmarks blogs have gone on to spawn
                    ...
                    You also agree that this license includes the right for Best Bookmarks to make all
                    publicly-posted Content available to third parties selected by  Best Bookmarks, so
                    ...
                    to a Best Bookmarks partner for distribution or analysis would be licensing the
                    Best Bookmarks "firehose," a live feed of all public activity on  Best Bookmarks, to
                    ...
                    Content shared through Best Bookmarks Services - when you post something
                    ...
                    Best Bookmarks may add its own affiliate code to links posted on Best Bookmarks at its
                ...
                </p><p><strong>Content License to You:</strong></p><p>
                    As a Subscriber of the Services, Best Bookmarks grants you a worldwide, revocable,
                ...
                </p><p><strong>Compliance with Community Guidelines:</strong></p><p>
                    You agree that you won't violate Best Bookmarks's    Community Guidelines.
                </p><p><strong>Termination and Deletion:</strong></p><p>
                    On termination of your Account, or upon your deletion of particular pieces
                    of Subscriber Content from the Services, Best Bookmarks shall make reasonable
                ...
                </p><h2>7. Special Provisions for Application Developers</h2><p>
                    If you develop software or services based on the Services or any Content,
                    whether using the
                    
                        Best Bookmarks Application Programming Interface
                    
                    or not, you will agree to and comply with the
                    
                        Best Bookmarks Application Developer and API License Agreement
                    
                    .
                </p><h2>8. Use of Trademarks</h2><p>
                    Any use of Best Bookmarks's trademarks, branding, logos, and other such assets in
                    connection with the Services shall use    Best Bookmarks approved branding and
                    shall be in accordance with the
                    
                        Best Bookmarks Trademark Guidelines
                    
                    .
                </p><h2>9. Themes</h2><p>
                    Best Bookmarks makes available specialized HTML and CSS code ("    <strong>Best Bookmarks Template Code</strong>") for the design and layout of blog
                    pages available for use on some of the Services ("<strong>Themes</strong>
                    "). Certain Themes are available for purchase as a Paid Service (as defined
                    below) (such Themes, "<strong>Premium Themes</strong>"). Purchased Premium
                    ...
                    Best Bookmarks grants you a license to customize the Best Bookmarks Template Code to create
                    your own Themes for use on your blog page (each a "    <strong>Custom Theme</strong>"). If you choose, you may also contribute
                    ...
                    locations other than Best Bookmarks-owned or approved websites without our
                ...
                </p><h2>10. Paid Services</h2><p>
                    Some of the Services require payment of fees (the "    <strong>Paid Services</strong>," including without limitation Premium
                    ...
                    Best Bookmarks may, in its sole discretion, modify the functionality of, or
                    ...
                    below), except at Best Bookmarks's sole discretion and in accordance with the rules
                    ...
                    Best Bookmarks may change its prices for Paid Services at any time. To the extent
                    applicable, Best Bookmarks will provide you reasonable notice of any such pricing
                ...
                </p><h2>11. Special Provisions for Promotions</h2><p>
                    Some features of the Services may allow you to promote yourself to other
                    Subscribers, and some of these features may be Paid Services ("    <strong>Promotions</strong>").
                </p><p>
                    The following additional terms apply to Promotions:
                </p><p>
                    Things that you promote will comply with this Agreement; if they don't,
                    Best Bookmarks reserves the right, in its sole discretion, to cancel a Promotion
                    without refund or recourse to you.
                </p><p>
                    Best Bookmarks may remove or disable any Promotion for any reason in its sole
                    discretion.
                </p><p>
                    Unless otherwise specified, Best Bookmarks does not guarantee any activity that
                    Promotions may receive, including but not limited to clicks, Likes, and
                    Reblogs. Best Bookmarks cannot control how Subscribers interact with Promotions and
                    is not responsible for "click fraud" or other fraudulent actions by third
                    parties, including, without limitation, Subscribers. Best Bookmarks doesn't
                    ...
                    manner, and Best Bookmarks shall not be liable to you or responsible for any
                    ...
                    Promotions may allow targeting to some Subscriber characteristics. Best Bookmarks
                    ...
                    By submitting a Promotion, you license Best Bookmarks to run that Promotion for as
                    ...
                    EXTENT PERMITTED BY LAW, Best Bookmarks DISCLAIMS ALL WARRANTIES, EXPRESS OR
                    IMPLIED, OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, OR
                    NON-INFRINGEMENT. Best Bookmarks makes no representations or warranties of any kind
                    ...
                    with us will be secure. Best Bookmarks also makes no representations or warranties
                    ...
                    from Best Bookmarks or through the Services, will create any warranty not expressly
                    made herein.
                </p><h2>13. Time Limitation on Claims and Releases From Liability</h2><p>
                    You agree that any claim you may have arising out of or related to this
                    Agreement or your relationship with Best Bookmarks must be filed within one year
                    after such claim arose; otherwise, your claim is permanently barred.
                </p><p>
                    You further release, to the fullest extent permitted by law, Best Bookmarks and its
                    ...
                    with, or is directly or indirectly controlled by, Best Bookmarks (the “Best Bookmarks
                    ...
                    not Best Bookmarks or a Best Bookmarks Affiliate), including third party sites and
                    services.
                </p><p>
                    ...
                    Claims relating to any face-to-face meetings in any way related to Best Bookmarks
                    at any venues ("<strong>Meetups</strong>"), including without limitation
                    ...
                    information. Unless otherwise expressly disclosed in writing, Best Bookmarks does
                    ...
                    with the debtor."
                </p><h2>14. Limitation of Liability</h2><p>
                    TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, Best Bookmarks AND THE Best Bookmarks
                    ...
                    WHETHER OR NOT Best Bookmarks HAS BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE,
                    ...
                    Best Bookmarks AND THE Best Bookmarks AFFILIATES, FOR ANY CLAIM UNDER THIS AGREEMENT,
                ...
                </p><h2>15. Exclusions to Warranties and Limitation of Liability</h2><p>
                ...
                </p><h2>16. Termination</h2><p>
                    Either party may terminate this Agreement at any time by notifying the
                    other party. Best Bookmarks may terminate or suspend your access to or ability to
                    ...
                    of the terms or conditions of this Agreement. In particular, Best Bookmarks may
                    ...
                    you otherwise may have to Best Bookmarks or any third party and shall not relieve
                    you of your rights if you are a user in the European Economic Area which
                    are described in the Privacy Policy.
                </p><h2>17. Choice of Law and Venue</h2><p>
                    You and Best Bookmarks agree that we will resolve any claim or controversy at law
                    or equity that arises out of this Agreement or the Services in accordance
                    with this Section or as you and Best Bookmarks otherwise agree in writing. Before
                    resorting to formal dispute resolution, we strongly encourage you to
                    contact us to seek a resolution.
                </p><p><strong>Law and Forum for Legal Disputes:</strong></p><p>
                    ...
                    have against Best Bookmarks must be resolved exclusively by a state or federal
